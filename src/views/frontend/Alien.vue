<template>
  <div class="bg-dark">
    ...
    <div class="bg-cover cellection-bg d-flex align-items-center justify-content-center mb-5" style="background-image:url(https://images.unsplash.com/photo-1504333638930-c8787321eee0?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1500&q=80);">
    <h2 class="display-4 text-white font-weight-normal ls-2">特有品種</h2>
    </div>
    <div class="container">
      <div class="row">
...
export default {
  ...
  computed: {
    ...
    filterData() {
      return Object.values(this.products).filter((item) => item.category === '外星人');
    },
  },
  created() {
    this.getProducts();
